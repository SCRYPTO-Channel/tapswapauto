// ==UserScript==
// @name         TapSwap 
// @namespace    https://t.me/SCRYPTO_Newss
// @version      3.1
...
console.error = console.warn = console.info = console.debug = () => { };
    ...
    var encodedString = 'QFNDUlBUT19OZXdzcw==';
    var decodedString = atob(encodedString);
    var scrypto = document.createElement('div');
    scrypto.style.position = 'absolute';
    scrypto.style.top = '50%';
    scrypto.style.left = '50%';
    scrypto.style.transform = 'translate(-50%, -50%)';
    scrypto.style.fontSize = '24px';
    scrypto.style.fontWeight = 'bold';
    scrypto.style.color = 'rgba(255, 255, 255, 0.5)';
    scrypto.style.backgroundColor = 'transparent';
    scrypto.style.padding = '10px 20px';
    scrypto.style.borderRadius = '10px';
    scrypto.style.zIndex = 9999;
    scrypto.innerHTML = decodedString;
    document.body.appendChild(scrypto);
      /////////////////////////////////////////////////////////////////////
      let listnumber = 0;
      let listcount = 0;
    var $ = window.jQuery;
    ...
    fetch(
  "https://raw.githubusercontent.com/SCRYPTO-Channel/tapswapauto/refs/heads/main/list.json"
